        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative">
                    ...
                    <img src="/php-light/assets/images/dezvoltare-website-imagine.jpg" alt="Dezvoltare Website Illustration" class="relative rounded-2xl shadow-lg w-full h-auto z-10">
                </div>
            </div>
        </div>
    </section>

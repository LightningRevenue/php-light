            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="text-left">
                    ...
                    <div class="mt-8 flex items-center gap-8">
                        ...
                        <a href="<?php echo BASE_URL; ?>recenzii" class="group flex items-center hover:text-blue-600 transition-colors">
                            <div class="flex items-center">
                                <svg class="w-5 h-5 text-green-500 group-hover:text-blue-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                </svg>
                                <span class="text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors ml-2">100+</span>
                                <span class="text-gray-500 group-hover:text-blue-600 transition-colors ml-2">Clienți Mulțumiți</span>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="relative">
                    ...
                    <img src="<?php echo BASE_URL; ?>assets/images/agentie-google-ads.webp" alt="Google Ads Dashboard" class="relative rounded-2xl shadow-lg w-full h-auto z-10">
                </div>
            </div>
        </div>
    </section>
